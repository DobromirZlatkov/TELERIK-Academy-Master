...
class ShoppingCenter
{
    ...
    //private static ShoppingCenterDBSlow shoppingCenterDB =
    //    new ShoppingCenterDBSlow();
        ...
        string[] cmdArguments)
    {
        ...
        var products = shoppingCenterDB.FindProductsByPriceRange(
            fromPrice, toPrice);
        PrintProducts(products);
    }
...
class ShoppingCenterDBFast
{
    ...
    {
        foreach (var product in productsToDelete.ToList())
        {
