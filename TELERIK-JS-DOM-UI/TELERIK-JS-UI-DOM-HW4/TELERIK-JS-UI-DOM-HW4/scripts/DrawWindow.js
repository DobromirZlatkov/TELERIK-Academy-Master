function drawWindows8Screen() {
    ...
    image = createImage('151', '480', '100', '80', 'images/fish.png');
    svg.appendChild(image);

    image = createImage('523', '365', '99', '99', 'images/pinBall.jpg');
    svg.appendChild(image);

    image = createImage('530', '277', '50', '50', 'images/MikeGibbs.jpg');
    svg.appendChild(image);
    ...
    image = createImage('986', '154', '72', '99', 'images/2s.jpg');
    svg.appendChild(image);

    // Come on :) Who will draw all those icons, and what's the point showing that I can use Gimp/Photoshop. I will priview some of them and the others will leave empty
    ...
    image = createImage('850', '170', '60', '60', 'images/music.png');
    svg.appendChild(image);

    image = createImage('390', '170', '50', '50', 'images/photos.png');
    svg.appendChild(image);
    ...
    image = createImage('850', '280', '50', '50', 'images/finance.png');
    svg.appendChild(image);

    image = createImage('175', '385', '50', '50', 'images/video.png');
    svg.appendChild(image);

    image = createImage('995', '375', '70', '70', 'images/reader.png');
    svg.appendChild(image);

    image = createImage('785', '375', '70', '70', 'images/skyDrive.png');
    svg.appendChild(image);

    image = createImage('380', '480', '60', '60', 'images/weather.png');
    svg.appendChild(image);

    image = createImage('655', '485', '50', '50', 'images/XBoxCompanion.png');
    svg.appendChild(image);
